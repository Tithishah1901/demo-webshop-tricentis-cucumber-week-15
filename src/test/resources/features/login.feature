...
Feature: Login Page Functionality
  ...
  Scenario: Verify the error message with invalid credentials
    ...
    When I enter an invalid EmailId "kasa@gmail.com"
    And I enter an invalid Password "k123457"
  ...
  Scenario: Verify that user should log in successfully with valid credentials
    Given I am on the login page
    When  I enter a valid EmailId "Radhika.shah1901@gmail.com"
    And I enter a valid password "Radhika123"
    And I click on the login button
